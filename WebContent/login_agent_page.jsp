...
<html>
	...
	<head>
		<title>Connexion Agent Juridique</title>
		<meta charset="utf-8" />
	...
	<body>
		...
		<!-- Signup Form -->
		<form method="post" action="LoginAgentServlet" id="signup-form">
		...
		<footer id="footer">
			...
			<h5> <a href="login_client_page.jsp" > Se connecter sous Client </a> </h5> <br>
			<a href="signup_agent_page.jsp" >Vous n'etes pas inscrit ?</a> <br><br><br>
