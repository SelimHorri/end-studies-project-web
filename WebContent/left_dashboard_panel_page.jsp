	...
	<nav class="navbar navbar-expand-sm navbar-default">
		...
		<div id="main-menu" class="main-menu collapse navbar-collapse">
			<ul class="nav navbar-nav">
				<li class="active"><a href="index_proprietaire.jsp"> <i
				...
				<li ><a href="gerer_reservation_page.jsp"  aria-haspopup="true"
					aria-expanded="false"> <i class="menu-icon fa fa-laptop"></i>
						Gérer <u>Réservations</u>
				</a>
					
				<li ><a href="gerer_contrat_bail_page.jsp" aria-haspopup="true"
					aria-expanded="false"> <i class="menu-icon fa fa-laptop"></i>
